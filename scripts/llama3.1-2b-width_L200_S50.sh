...
python -u multihost_runner_orig.py \
    ...
    ~/maxtext_env/bin/python -u -m MaxText.train MaxText/configs/base.yml \
        run_name=${RUN_NAME} \
        load_parameters_path=gs://${BUCKET_NAME}/model_ckpts/llama3-8b-l200_width_task_wikitext_hidden_size_1792_ffn_hidden_size_5632_calib_size_128_seqlen_8192/checkpoints/0/items \
