...
orbax_ckpt_name="llama3.1-4b-width_L200_S50_seqlen_8192_bs_1_grad_accum_1_lr_0.0003_min_lr_ratio_0.1_warmup_ratio_0.05"
...
bash scripts/convert.sh weights_test \
    --model=${model} \
    --direct_run_name=${direct_run_name} \
    --hf_model_name="llama3_4b_width_seq_8192_bs_2_global_bs_64_steps_12500_lr_0.0003_minlr_ratio_0.1_warmup_0.05/step_${step}_ckp_hf"