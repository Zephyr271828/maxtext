...
export RUN_NAME="${MODEL_NAME}_dclm_L200_S200"
export ASYNC_CHECKPOINTING=false
export CONVERTED_CHECKPOINT="gs://$BUCKET_NAME/model_ckpts/minitron/llama3_4b_width_orbax/0/items"
export BASE_OUTPUT_DIRECTORY="gs://$BUCKET_NAME/model_ckpts/maxtext"
export DATASET_PATH='/home/zephyrgcs-bucket/datasets/'

# source /home/zephyrgcs-bucket/miniconda3/etc/profile.d/conda.sh
# conda activate /home/zephyrgcs-bucket/conda_envs/maxtext
