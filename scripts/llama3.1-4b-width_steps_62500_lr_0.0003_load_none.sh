...
export RUN_NAME="llama3.1-4b-width_L200_S50_seqlen_8192_bs_2_grad_accum_4_lr_0.0003_min_lr_ratio_0.1_warmup_ratio_0.05"
...
bash scripts/convert.sh gen_param_ckpt \
    ...
    --direct_run_name=direct_llama3.1-4b-width_steps_62500_lr_0.0003_load_none
