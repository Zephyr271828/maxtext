...
export RUN_NAME="llama3.1-8b_L200_S50_seqlen_8192_bs_2_grad_accum_4_lr_0.0003_min_lr_ratio_0.1_warmup_ratio_0.05"
...
bash scripts/convert.sh gen_param_ckpt \
    --model=${MODEL_NAME} \
    --orbax_ckpt_path=${BASE_OUTPUT_DIRECTORY}/${RUN_NAME}/checkpoints/49999/items \
    --hf_model_path=/home/zephyr/gcs-bucket/model_ckpts/Llama-3.1-8B \
    --direct_run_name=direct_llama3.1-8b_steps_50000_lr_0.0003_load_none
