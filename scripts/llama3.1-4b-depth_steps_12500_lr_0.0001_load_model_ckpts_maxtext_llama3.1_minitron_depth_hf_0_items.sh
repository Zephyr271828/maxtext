...
export RUN_NAME="llama3.1-4b-depth_L200_S50_seqlen_8192_bs_2_grad_accum_4_lr_0.0001_min_lr_ratio_0.1_warmup_ratio_0.05"
...
bash scripts/convert.sh gen_param_ckpt \
    ...
    --direct_run_name=direct_llama3.1-4b-depth_steps_12500_lr_0.0001_load_model_ckpts_maxtext_llama3.1_minitron_depth_hf_0_items
