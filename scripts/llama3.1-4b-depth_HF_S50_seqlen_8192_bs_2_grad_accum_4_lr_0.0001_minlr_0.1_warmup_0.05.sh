...
python -u multihost_runner_orig.py \
    ...
    python3.10 -u -m MaxText.train MaxText/configs/base.yml \
        run_name=${RUN_NAME} \
        load_parameters_path=gs://${BUCKET_NAME}/model_ckpts/llama3.1-4b-depth-orbax/0/items \
...
bash scripts/convert.sh gen_param_ckpt \
    ...
    --direct_run_name=direct_llama3.1-4b-depth_HF_S50_seqlen_8192_bs_2_grad_accum_4_lr_0.0001_minlr_0.1_warmup_0.05
